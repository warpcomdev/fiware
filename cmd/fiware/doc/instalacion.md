...
- Dentro del fichero comprimido se encuentra un ejecutable (`fiware` en el caso linux y `models.exe` en el caso windows). Es un ejecutable de **línea de comandos**, no basta hacer doble click en él; hay que abrir la línea de comandos y escribir `fiware`
